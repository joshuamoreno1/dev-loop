...
LABELS=(
  ...
  "prd:plan-review|A2EEEF|Implementation plan under review by the architect agent + stack specialist (Gate A)"
  "prd:plan-approved|2EA043|The agents approved the plan → ready for R2 to implement"
  "prd:building|1D76DB|Implementation in progress"
  "prd:arch-review|5319E7|PR open, under review by the architect agent"
  "prd:ready-for-review|0052CC|CI green + comments resolved + architect approved — ready for the owner"
